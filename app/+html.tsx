...
// Painted before the JS bundle boots, so the launch doesn't flash white on a
// dark-themed app. Overscroll is pinned too — rubber-banding the whole document
// is the tell that gives away a web app running fullscreen.
const BASE_STYLE = `
html, body {
